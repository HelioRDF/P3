 ...
 * @author hfranca
 */
public class Listar_exames extends javax.swing.JFrame {

    /**
     * Creates new form Listar_exames
     */
    public Listar_exames() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Fechar.setBounds(740, 560, 49, 39);
        ...
        jLabel10.setText("Relação de exames:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_exames.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
