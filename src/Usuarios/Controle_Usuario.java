 ...
 * @author Helio Franca
 */
public class Controle_Usuario {//Inicio da classe Controle
    
    // Cria um array list de objetos do tipo Usuário.
    ArrayList <GetSet_Usuario> Controle; 
...
//=============================================================================================================   
//2.A Buscar Usuário pelo nome. Retorna o Objeto.
    ...
    public String buscarNome(String NomeB){//Inicio método buscar
        ...
        for (GetSet_Usuario objeto:Controle){//Inicio for
            
            if(objeto.getNomeUsuário().equalsIgnoreCase(NomeB)){
                encontrou=true;
                break; }                      }//Fim for.
...
//.................................................................................
        ...
        for (GetSet_Usuario objeto:Controle){ //Inicio for 2. 
          i++;
          if(encontrou==false){//Inicio do If.
              JOptionPane.showMessageDialog(null, "Usuário não encontrado");
              break;      }//Fim do If
          
          if(objeto.getNomeUsuário().equalsIgnoreCase(NomeB)){// Inicia If
...
public String buscarCodigo(int registro){//Inicio do método de buscar por código
 ...
 int i =0;
    ...
    for(GetSet_Usuario objeto:Controle){//Inicio do for
     
     
     if(objeto.getCRM()==registro){//Inicio do if.
         encontrou=true;
         break;                 }//fim do if
                                       }//Fim  do for
...
public void apagar(String deletar){//Inicio do método apagar.
 ...
 for (GetSet_Usuario objeto:Controle){//Inicio do for.
     ...
     if(objeto.getNomeUsuário().equalsIgnoreCase(Nome)){//Início do if
         encontrou=true;
         break;                                 }//Fim do if
...
public Integer atualizar (String atualizar){//Inicio do método atualizar.
    ...
    for(GetSet_Usuario objeto:Controle){//Inicio For.
        ...
        if(objeto.getNomeUsuário().equalsIgnoreCase(atualizar)){//inicio if.
            encontrou=true;
            break;                                      }//fim do if.
                                         }//Fim do for.
     ...
     JOptionPane.showMessageDialog(null,"Paciente não encontrado");
       ...
       if(objeto.getNomeUsuário().equalsIgnoreCase(atualizar)){//inicio if.
           ...
           nome+=objeto.imprimirDados();
            JOptionPane.showMessageDialog(null,i+ " -Alterando informações do Usuario:\n"+nome); 
...
public String imprimir(){//Inicio do método.
 ...
 if(Controle.isEmpty()){//Inicio do if.
     ...
     for(GetSet_Usuario obejeto:Controle){//Inicio do for
